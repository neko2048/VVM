...
REAL :: dx, dy, dz, dz1, lon, lat, cir1, cir2 \
INTEGER :: i, j ,k, nx, ny \
CHARACTER(100) :: var, var2, var3, var4 \
  \
...
READ(var2(7:i-2),*) lon \
  \
IF (lon/=120.95 .AND. lat/=23.458)THEN \
cir1=6371000.*2.*pi*cos(lat/180.*pi) \
cir2=6371000.*2.*pi \
cir1=dx/cir1*360 \
cir2=dy/cir2*360 \
ELSE \
...
WRITE(10,777) lon, ",", cir1 \
777 FORMAT(f8.4,a1,f12.8) \
WRITE(10,777) lat, ",", cir2 \
CLOSE(10) \
  \
